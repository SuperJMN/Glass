...
{
    public class RectangleSelectionAdorner : Adorner
    {
        ...
        /// </summary>
        public static readonly DependencyProperty TemplateProperty = DependencyProperty.Register("Template", typeof(ControlTemplate), typeof(RectangleSelectionAdorner), new FrameworkPropertyMetadata(null, OnTemplateChanged));
        ...
        {
            var target = (RectangleSelectionAdorner)d;
            var oldTemplate = (ControlTemplate)e.OldValue;
            var newTemplate = target.Template;
        ...
        public static readonly DependencyProperty LeftProperty =
            DependencyProperty.Register("Left", typeof(double), typeof(RectangleSelectionAdorner),
        ...
        public static readonly DependencyProperty TopProperty =
            DependencyProperty.Register("Top", typeof(double), typeof(RectangleSelectionAdorner),
                new FrameworkPropertyMetadata(0.0));
